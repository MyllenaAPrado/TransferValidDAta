...
if __name__ == '__main__':
    ...
    for train_folders, val_folder, test_folders in k_folders():
        if dataset == "VALID":
            ...
            test_dataset = VALID_datset(folders=test_folders, transform=transform_eval, print_folder=True)
            ...
            test_dataset = Win5LID_datset(folders=test_folders, transform=transform_eval, print_folder=True)
            ...
            test_dataset = LFDD_datset(folders=test_folders, transform=transform_eval, print_folder=True)
